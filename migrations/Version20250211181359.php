 ...
 */
final class Version20250211181359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokedex (id INT AUTO_INCREMENT NOT NULL, evolution_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, type LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', image VARCHAR(255) NOT NULL, evolution_level INT DEFAULT NULL, UNIQUE INDEX UNIQ_6336F6A7CDFF215A (evolution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pokedex ADD CONSTRAINT FK_6336F6A7CDFF215A FOREIGN KEY (evolution_id) REFERENCES pokedex (id)');
